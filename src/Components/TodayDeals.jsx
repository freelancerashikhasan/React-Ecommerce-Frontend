...
function TodayDeals() {
    ...
    useEffect(() => {
        axios.get('http://ecommerce-backend.test.com/api/product/today_deals')
        .then(response => {
...
<div className="rts-featured_products-section section-5 section-gap">
        <div className="container">
            <div className="section-header section-header4">
                ...
                ">Today Deals </span>
                <a href="shop-main.html" className="go-btn">Today Deals <i className="fal fa-long-arrow-right"></i></a>
            </div>
